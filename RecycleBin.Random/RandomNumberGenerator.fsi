...
type RandomBuilder<'s> =
   ...
   /// </returns>
   member Run : m:(PrngState<'s> -> 'a * PrngState<'s>) -> 'a * 's
...
/// </summary>
val ``(0, 1)`` : (PrngState<'s> -> float * PrngState<'s>)
/// <summary>
/// Returns a random number in the range of [0, 1).
/// </summary>
val ``[0, 1)`` : (PrngState<'s> -> float * PrngState<'s>)
...
/// <seealso cref="(0, 1]" />
/// <seealso cref="[0, 1]" />
val uniform : min:float * max:float -> (PrngState<'s> -> float * PrngState<'s>)
/// <summary>
/// Returns a random number distributed normally.
/// </summary>
/// <param name="mean">The mean.</param>
/// <param name="standardDeviation">The standard deviation.</param>
val normal : mean:float * standardDeviation:float -> (PrngState<'s> -> float * PrngState<'s>)
/// <summary>
...
val gamma : shape:float * scale:float -> (PrngState<'s> -> float * PrngState<'s>)
/// <summary>
