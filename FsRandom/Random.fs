...
let inline next (generator:GeneratorFunction<_, _>) =
   curry (runRandom generator >> fun (r, (_, s)) -> r, s)
let inline get (generator:GeneratorFunction<_, _>) =
   curry (evaluateRandom generator)
