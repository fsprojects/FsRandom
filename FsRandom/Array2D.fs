...
let randomCreate rowCount columnCount (generator:GeneratorFunction<_, _>) =
   if rowCount < 0 then
...
let randomCreateBased rowBase columnBase rowCount columnCount (generator:GeneratorFunction<_, _>) =
   if rowCount < 0 then
      outOfRange "rowCount" "`rowCount' must not be negative."
   elif columnCount < 0 then
      outOfRange "columnCount" "`columnCount' must not be negative."
...
let randomInit rowCount columnCount (initializer:int -> int -> GeneratorFunction<_, _>) =
   if rowCount < 0 then
      outOfRange "rowCount" "`rowCount' must not be negative."
   elif columnCount < 0 then
      outOfRange "columnCount" "`columnCount' must not be negative."
...
let randomInitBased rowBase columnBase rowCount columnCount (initializer:int -> int -> GeneratorFunction<_, _>) =
   if rowCount < 0 then
      outOfRange "rowCount" "`rowCount' must not be negative."
   elif columnCount < 0 then
      outOfRange "columnCount" "`columnCount' must not be negative."
